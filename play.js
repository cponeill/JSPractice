...
var JSONTest = [{"name": "Emma de Milliano", "sex": "f", "born": 1876, "died": 1956,"father": "Petrus de Milliano","mother": "Sophia van Damme"},
              {"name": "Carolus Haverbeke", "sex": "m","born": 1832, "died": 1905,"father": "Carel Haverbeke","mother": "Maria van Brussel"},
              ];

/*
console.log(filter(JSONTest, function(name) {
    if (name.died < 1930) {
        return name;
    }
})); */

// Playing with the ANCESTRY_FILE

var ancestry = JSON.parse(ANCESTRY_FILE);
//console.log(ancestry.length);

// Using Filter to parse a JSON object.
